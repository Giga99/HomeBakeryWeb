    ...
    return (
        <nav className="relative flex justify-between items-center h-[150px]">
            <h1 className="font-['Sansita'] font-[800] text-[35px] lg:text-[50px] text-[#424242] italic mb-10">
                <Link to="/orders">Home Bakery</Link>
            </h1>
            ...
            {isMenuOpen && (
                <div
                    className="flex flex-col gap-5 absolute top-[100px] right-0 px-6 py-7 w-[308px] h-[140px] bg-[#ffffff] text-[20px] shadow-md z-50">
                    <Link to="/add-cake" className="flex items-center gap-2">
                        <img src="static/svg/add.svg" alt="" className="h-7"/>
